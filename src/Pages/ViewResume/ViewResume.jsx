...
const ViewResume = () => {
  ...
  const downloadPDF = () => {
    const element = document.getElementById('resume-content');  // Select the resume content
    const opt = {
      margin: [10, 0, 10, 0], // Customize margins as needed
  ...
  return (
    <>
      ...
      <div className="resume-container" id="resume-content"> {/* Add ID to target for PDF */}
        <div className="logo-container">
          <img src={Logo} alt="logo" className='logo' />
        </div>
        <div className="personal-info">
